...
rf.metrics <- function(x, y, accession, model) {
  ...
  write.csv(cm, paste0("Results/DiagnosticGenes/testML/", accession, ".ConfusionMatrix.csv"))
  ...
  write.csv(mats, paste0("Results/DiagnosticGenes/testML/", accession, ".Metrics.csv"))
  return(mats)
}
