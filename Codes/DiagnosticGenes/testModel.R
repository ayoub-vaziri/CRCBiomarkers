...
rf.metrics <- function(x, y, accession, model) {
  ...
  write.csv(cm, paste0("Results/DiagnosticGenes/testModel/", accession, ".ConfusionMatrix.csv"))
  ...
  write.csv(mats, paste0("Results/DiagnosticGenes/testModel/", accession, ".Metrics.csv"))
  return(mats)
}
...
svm.metrics <- function(x, y, accession, model) {
  ...
  write.csv(cm, paste0("Results/DiagnosticGenes/t/", accession, ".ConfusionMatrix.csv"))
...
#### Evaluation of ML models on test set ####
#############################################
...
rf.metrics(x, y, "Test set for RF", RF)
svm.metrics(x, y, "Test set for SVM", SVM)
#############################################