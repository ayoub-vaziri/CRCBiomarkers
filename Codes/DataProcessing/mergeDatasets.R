...
write.csv(expr10950, "Results/DataProcessing/mergeDatasets/expr10950.csv")
write.csv(expr25070, "Results/DataProcessing/mergeDatasets/expr25070.csv")
write.csv(expr41328, "Results/DataProcessing/mergeDatasets/expr41328.csv")
write.csv(expr74602, "Results/DataProcessing/mergeDatasets/expr74602.csv")
write.csv(expr142279, "Results/DataProcessing/mergeDatasets/expr142279.csv")
######################
...
write.csv(phen10950_, "Results/DataProcessing/mergeDatasets/phen10950.csv")

phen25070_ <- as.data.frame(cbind(sample=rownames(phen25070), group=phen25070[,1]))
write.csv(phen25070_, "Results/DataProcessing/mergeDatasets/phen25070.csv")

phen41328_ <- as.data.frame(cbind(sample=rownames(phen41328), group=phen41328[,8]))
write.csv(phen41328_, "Results/DataProcessing/mergeDatasets/phen41328.csv")

phen74602_ <- as.data.frame(cbind(sample=rownames(phen74602), group=phen74602[,8]))
write.csv(phen74602_, "Results/DataProcessing/mergeDatasets/phen74602.csv")

phen142279_ <- as.data.frame(cbind(sample=rownames(phen142279), group=phen142279[,36]))
write.csv(phen142279_, "Results/DataProcessing/mergeDatasets/phen142279.csv")
########################################


#### Load expression data ####
##############################
expr10950 <- as.data.frame(fread("Results/DataProcessing/mergeDatasets/expr10950.csv"))
rownames(expr10950) <- expr10950$V1
expr10950 <- expr10950[,-1]

expr25070 <- as.data.frame(fread("Results/DataProcessing/mergeDatasets/expr25070.csv"))
rownames(expr25070) <- expr25070$V1
expr25070 <- expr25070[,-1]

expr41328 <- as.data.frame(fread("Results/DataProcessing/mergeDatasets/expr41328.csv"))
rownames(expr41328) <- expr41328$V1
expr41328 <- expr41328[,-1]

expr74602 <- as.data.frame(fread("Results/DataProcessing/mergeDatasets/expr74602.csv"))
rownames(expr74602) <- expr74602$V1
expr74602 <- expr74602[,-1]

expr142279 <- as.data.frame(fread("Results/DataProcessing/mergeDatasets/expr142279.csv"))
...
##############################
phen10950 <- as.data.frame(fread("Results/DataProcessing/mergeDatasets/phen10950.csv", header = TRUE))
...
phen25070 <- as.data.frame(fread("Results/DataProcessing/mergeDatasets/phen25070.csv", header = TRUE))
...
phen41328 <- as.data.frame(fread("Results/DataProcessing/mergeDatasets/phen41328.csv", header = TRUE))
...
phen74602 <- as.data.frame(fread("Results/DataProcessing/mergeDatasets/phen74602.csv", header = TRUE))
...
phen142279 <- as.data.frame(fread("Results/DataProcessing/mergeDatasets/phen142279.csv", header = TRUE))
...
write.csv(mergedExpr, "Results/DataProcessing/mergeDatasets/mergeDatasets.csv")
##########################